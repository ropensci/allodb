# Getting help with fgeo

Thanks for using fgeo. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to search _issues_ and _pull requests_ in the relavant package ([here is the list of all __fgeo__ packages](https://github.com/forestgeo/fgeo/issues)) to make sure the bug 
hasn't been reported and/or already fixed in the development version. By 
default, the search will be pre-populated with `is:issue is:open`. You can 
[edit the qualifiers](https://help.github.com/articles/searching-issues-and-pull-requests/) (e.g. `is:pr`, `is:closed`) as needed. For example, you'd simply
