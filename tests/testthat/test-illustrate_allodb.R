...
test_that("illustrate_allodb() accepts changes in the equation table used", {
  ...
  g2 <- illustrate_allodb(
    genus = "Quercus",
    coords = c(-78, 40),
    new_eqtable = new_equations(new_allometry = "0.12 * dbh ^ 2.5",
                                new_taxa = "Quercus",
                                new_coords = c(-80, 40),
                                new_minDBH = 5,
                                new_maxDBH = 40,
