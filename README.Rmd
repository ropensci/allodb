...
As an example, we use data from the Smithsonian Conservation Biology Institute, USA (SCBI) ForestGEO dynamics plot (1st census). Data can be requested through the ForestGEO portal (https://forestgeo.si.edu/)
