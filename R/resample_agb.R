...
#'
#' After attributing a weight to each equation in \pkg{allodb}  using the `weight_allom()`
...
#'   `new_equations()` function. Default is the original \pkg{allodb}  equation table.
