...
TODO: LET ME KNOW IF YOU NEED HELP. BELOW I SHOW A GIST OF
WHAT A `validate_equation()` MIGHT LOOK LIKE.

## Unsafe

[Online we found](https://stackoverflow.com/questions/13649979/what-specifically-are-the-dangers-of-evalparse) that parsing text would be a risk if we hosted an application
on a server we own and allow users to input arbitrary text. A malicious user 
